...
from src.inference.image_classification_inference import ImageClassifier
from app_io import get_prompt
from src.utilities.shared_thread_resources import exit_event
...
async def infer_image_handler():
    ...
    from src.utilities.shared_thread_resources import latest_screenshot, inferred_game_state, inferred_memory_collection
